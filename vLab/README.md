...
This project was made to modify the configuration of all Juniper devices (e.g. router, switches, firewalls...) and build complete topologies in VMware automatically.
